...
public class Main {
    public static void main(String[] args) {
        ...
        double doubleProduct = 5.5;
        double doubleDifference = 6.5;
        double doubleQuotient = 7.5;
        ...
        doubleQuotient = intOperandA / intOperandB;
        ...
        System.out.println("Is it raining today?: " + isItRaining);
        double gasPrice = 3.49;
        System.out.println("A gallon of gas is: " + gasPrice + " dollars");
        int favNumber = 7;
        ...
        String name = "Brycen Matthew Perez";
